...
The original edition of this book was written by Lisa Tauxe with contributions from R.F. Butler, S.K. Banerjee, and R. van der Voo. With Lisa's blessing, [Nick Swanson-Hysell](https://cse.umn.edu/esci/nicholas-swanson-hysell) is porting, revising, and updating the text into an interactive web book format. 

Chapters that are solely ported from the previous edition have Lisa listed as the sole author. When substantive additions and revisions have been made by Nick, both are listed as a chapter author.

This version includes 3D visualizations and figures including those developed through integrated code that draws on [PmagPy](https://pmagpy.github.io/PmagPy-docs/intro.html) {cite}`tauxe2016_pmagpy`. Chapters are being added and revised on a rolling basis as of Spring 2026.  The previous edition is available at [EarthRef.org](https://earthref.org/MagIC/books/Tauxe/Essentials/) and the source for that edition is on [GitHub](https://github.com/pmagpy/Essentials-JupyterBook).
:::
