...
1. The proportionality "constant" $\nu$ may not be constant at all because the NRM acquisition may not be even approximately linear with the applied field (see [Chapter 7](#chap:remanence)).
...
3. If the original NRM is carried by multidomain or even "PSD" grains in what we called pseudo-multidomain grain size, the exact conditions of NRM acquisition will be difficult to reproduce because unblocking may occur at a different temperature than blocking.
...
f) The location of the 1960 lava flow (really close to the 2018 one!) is 19.52 latitude and -154.81 longitude. Figure out what the field was at the site using the tricks you learned in [Chapter 2](#chap:geomag).
