...
3. Application of a magnetic field exerts an aligning torque on the atomic magnetic moments. The magnetic energy $E_m$ (see also [Chapter 1](#chap:physics)) of a magnetic moment $\m$ at an angle $\theta$ with an external magnetic field $\B=\mu_o \H$ is given by:
...
a) Do this problem first in cgs units. Then convert your answer to SI using the conversion factors in Table 1.1 in [Chapter 1](#chap:physics).
