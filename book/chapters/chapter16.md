...
#: Rotation number. Rotations performed in order using algorithm in Appendix A.3.5. $\lambda, \phi, \Omega$ are the latitude, longitude and angle of the finite rotation pole. AF: Africa, AUS: Australia, ANT: East Antarctica, IND: India, SAM: South America, NAM: North America, EUR: Europe and GRN: Greenland.
:::
...
b) Use the function **pmag.pt_rot( )** to transform the North American pole to South African coordinates using the method outlined in the Appendix. The North American pole for 90 Ma in BC02 is $\lambda=75.2^{\circ}, \phi=201^{\circ}$. The African pole is $\lambda=66.8^{\circ}, \phi=244.5^{\circ}$. How do your answers compare?
